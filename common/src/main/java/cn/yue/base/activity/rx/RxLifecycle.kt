...
object RxLifecycle {
     ...
     */
    @CheckReturnValue
    fun <T : Any, R : Any> bindUntilEvent(lifecycle: Observable<R>,
                                          event: R): LifecycleTransformer<T> {
        return bind(takeUntilEvent(lifecycle, event))
    }

    private fun <R : Any> takeUntilEvent(lifecycle: Observable<R>, event: R): Observable<R> {
     ...
     */
    @CheckReturnValue
    fun <T : Any, R : Any> bind(lifecycle: Observable<R>): LifecycleTransformer<T> {
     ...
     */
    @CheckReturnValue
    fun <T : Any, R : Any> bind(lifecycle: Observable<R>,
                                correspondingEvents: Function<R, R>): LifecycleTransformer<T> {
        return bind(takeUntilCorrespondingEvent(lifecycle.share(), correspondingEvents))
    }

    private fun <R : Any> takeUntilCorrespondingEvent(lifecycle: Observable<R>,
