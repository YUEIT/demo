package cn.yue.base.widget.refresh;
...
import cn.yue.base.widget.refresh.api.RefreshComponent;
import cn.yue.base.widget.refresh.api.RefreshContent;
import cn.yue.base.widget.refresh.api.RefreshFooter;
import cn.yue.base.widget.refresh.api.RefreshHeader;
import cn.yue.base.widget.refresh.api.RefreshKernel;
import cn.yue.base.widget.refresh.api.RefreshLayout;
import cn.yue.base.widget.refresh.constant.DimensionStatus;
import cn.yue.base.widget.refresh.constant.RefreshState;
import cn.yue.base.widget.refresh.constant.SpinnerStyle;
import cn.yue.base.widget.refresh.listener.DefaultRefreshFooterCreator;
import cn.yue.base.widget.refresh.listener.DefaultRefreshHeaderCreator;
import cn.yue.base.widget.refresh.listener.DefaultRefreshInitializer;
import cn.yue.base.widget.refresh.listener.OnLoadMoreListener;
import cn.yue.base.widget.refresh.listener.OnMultiListener;
import cn.yue.base.widget.refresh.listener.OnRefreshListener;
import cn.yue.base.widget.refresh.listener.OnRefreshLoadMoreListener;
import cn.yue.base.widget.refresh.listener.OnStateChangedListener;
import cn.yue.base.widget.refresh.listener.ScrollBoundaryDecider;
import cn.yue.base.widget.refresh.simple.SimpleBoundaryDecider;
import cn.yue.base.widget.refresh.util.SmartUtil;
import cn.yue.base.widget.refresh.wrapper.RefreshContentWrapper;
import cn.yue.base.widget.refresh.wrapper.RefreshFooterWrapper;
import cn.yue.base.widget.refresh.wrapper.RefreshHeaderWrapper;
...
//    }
    ...
    public RefreshLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(DisplayUtils.dp2px((int)heightDp));
    }
...
//                  mRefreshHeader.getView().requestLayout();
    ...
    public RefreshLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(DisplayUtils.dp2px((int)heightDp));
    }
...
//                  mRefreshFooter.getView().requestLayout();
    ...
    public RefreshLayout setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = DisplayUtils.dp2px((int)insetDp);
        return this;
    }
    ...
    public RefreshLayout setFooterInsetStart(float insetDp) {
        mFooterInsetStart = DisplayUtils.dp2px((int)insetDp);
        return this;
    }
