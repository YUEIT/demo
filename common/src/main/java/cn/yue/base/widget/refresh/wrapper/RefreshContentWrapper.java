...
import cn.yue.base.widget.refresh.listener.CoordinatorLayoutListener;
...
import cn.yue.base.widget.refresh.util.DesignUtil;
        ...
        if (content instanceof ViewGroup && event != null) {
            ...
            for (int i = childCount; i > 0; i--) {
                ...
                if (SmartUtil.isTransformedTouchPointInView(viewGroup, child, event.x, event.y, point)) {
                    if (child instanceof ViewPager || child instanceof ViewPager2 || !SmartUtil.isContentView(child)) {
    ...
    public void onAnimationUpdate(@NonNull ValueAnimator animation) {
        ...
        try {
            ...
            if (mScrollableView instanceof AbsListView) {
                SmartUtil.scrollListBy((AbsListView) mScrollableView, (int)dy);
            } else {
